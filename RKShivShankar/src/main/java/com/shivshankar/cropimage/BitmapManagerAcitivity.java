 ...
 */
public class BitmapManagerAcitivity {

    private static final String TAG = "BitmapManagerAcitivity";
    private static BitmapManagerAcitivity sManager = null;
    private final WeakHashMap<Thread, ThreadStatus> mThreadStatus =
            new WeakHashMap<Thread, ThreadStatus>();

    private BitmapManagerAcitivity() {

    }

    public static synchronized BitmapManagerAcitivity instance() {

        if (sManager == null) {
            sManager = new BitmapManagerAcitivity();
        }
        return sManager;
    }
